...
{
    public class MaleProductViewComponent : ViewComponent
    {
        private readonly ApplicationDbContext _db;

        public MaleProductViewComponent(ApplicationDbContext db)
        {
            _db = db;
        }
        public IViewComponentResult Invoke()
        {
            ...
            var allCategory = _db.CategoryModel.Where(c => c.Type == ProductType.MALE).ToList();
