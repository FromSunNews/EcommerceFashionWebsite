...
-----------------------------------------------------------------------*/
    ...
    jQuery(document).ready(function(){
        jQuery('#backbutton').click(function(){
            jQuery('#checkoutbtn').removeClass('show');
            jQuery('#cartbtn').addClass('show');
            jQuery('#iq-tracker-position-2').removeClass('active');
            jQuery('#iq-tracker-position-1').addClass('active');
        });
        jQuery('#place-order').click(function(){
            jQuery('#cartbtn').removeClass('show');
            jQuery('#checkoutbtn').addClass('show');
        ...
        jQuery('#deliver-address').click(function(){
            jQuery('#checkoutbtn').removeClass('show');
            jQuery('#paymentbtn').addClass('show');
            jQuery('#iq-tracker-position-2').removeClass('active');
